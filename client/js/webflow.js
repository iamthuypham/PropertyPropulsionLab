...
Webflow.require('ix').init([
  {"slug":"left-landing","name":"Left-Landing","value":{"style":{"opacity":0,"x":"-100px","y":"0px","z":"0px"},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"transform 1s ease-in-out 0, opacity 1s ease-in-out 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"appear-landing","name":"Appear-Landing","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"transform 500ms ease-in-out 0, opacity 2s ease-in-cubic 0"}],"stepsB":[]}]}},
  {"slug":"bottom-landing","name":"Bottom-Landing","value":{"style":{"opacity":0,"x":"0px","y":"200px","z":"0px"},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"transform 1.2s ease-in-out 0, opacity 1.2s ease-in-out 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}}
]);
